...
is($entity_common->entity_layer_index, 0, 'Dim layer index (0).');
is($entity_common->entity_size, 98, 'Entity size (98).');
...
is($dim1_data->dimension_line_defining_point_z, 0, 'Dimension line defining point z (0).');
...
is($dim1_data->extension_defining_point1_z, 0, 'Extension defining point1 z (0).');
...
is($dim1_data->extension_defining_point2_z, 1.0, 'Extension defining point2 z (1.0).');
