...
is($circle1_data->center_point_x, 1, 'Circle center point x (1).');
is($circle1_data->center_point_y, 1, 'Circle center point y (1).');
...
is($circle1_data->entity_elevation, 1, 'Circle elevation (1).');
is($circle1_data->entity_layer_index, 0, 'Circle layer index (0).');
